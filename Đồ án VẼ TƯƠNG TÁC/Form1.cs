...
namespace Ungdungvecoban
{
    public partial class Form_Client : Form
    {
        ...
        public Form_Client()
        {
            ...
            this.Resize += new EventHandler(Form_Client_Resize); // Lắng nghe sự kiện Resize
        ...
        private void Form_Client_Resize(object sender, EventArgs e)
        {
            if (Canvas.Width > 0 && Canvas.Height > 0 && (Canvas.Width != bitmap.Width || Canvas.Height != bitmap.Height))
            {
                ...
                using (Graphics newGraphics = Graphics.FromImage(newBitmap))
                {
                    ...
                    // Vẽ lại nội dung từ bitmap cũ vào bitmap mới
                    newGraphics.DrawImage(backupBitmap, 0, 0);
