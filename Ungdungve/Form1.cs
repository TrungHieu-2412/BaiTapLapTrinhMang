...
namespace ungdungve
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            btnEraser.Click += new EventHandler(btnEraser_Click); // Đăng ký sự kiện cho nút xóa
        ...
        private void drawingPanel_MouseMove(Object sender, MouseEventArgs e)
        {
            if (isDrawing)
            {
                ...
                {
                    Color penColor = isEraserMode ? Color.White : currentColor; // Chọn màu trắng nếu là chế độ xóa
        ...
        private void btnChooseColor_Click(object sender, EventArgs e)
        {
            ...
            if (colorDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                btnEraser.Text = "Eraser"; // Đặt lại tên nút bút xóa
            }
        }
        ...
        {
            if (!isEraserMode) // Chỉ lưu nếu không phải là chế độ xóa
            {
        ...
        {
            isEraserMode = !isEraserMode; // Chuyển đổi giữa chế độ vẽ và xóa
            btnEraser.Text = isEraserMode ? "Draw" : "Eraser"; // Cập nhật văn bản của nút
        }
    }
}
